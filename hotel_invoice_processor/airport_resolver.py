...
def prompt_and_save(truncated_name: str, parent=None) -> str:
    """
    ...
    Label(dialog, text="Unknown airport found in invoice:",
          font=("Arial", 9), bg="#ffffff", fg="#555555").pack(**pad, anchor="w", pady=(14, 0))

    Label(dialog, text=truncated_name,
          font=("Consolas", 12, "bold"), bg="#ffffff", fg="#000000").pack(**pad, anchor="w")
